"""
Reference - https://gist.github.com/nateraw/14818c6e4889fc13698e5ca1a2ace2ad
...
def download_clip(
    ...
    command = f"""
        yt-dlp --no-check-certificate --quiet --no-warnings -x --audio-format wav -f bestaudio -o "{output_filename}" --download-sections "*{start_time}-{end_time}" {url_base}{video_identifier}
    """.strip()
    attempts = 0
    while True:
        try:
